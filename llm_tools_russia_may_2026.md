...
| **OpenCode** | **Агрегатор** (12+ моделей, агентно-оптимизированные) | ✗ | Ограничена | DeepSeek V4 Pro/Flash, Qwen3.6 Plus, Qwen3.5 Plus, Kimi K2.6, GLM-5.1, MiniMax M2.7, MiMo-V2.5-Pro | **Zen**: pay-as-you-go ($20 пополнение, нулевая наценка, карта). **Go**: подписка $10/мес ($5 первый месяц), щедрые лимиты |
...
- **OpenCode (Zen/Go)** — агрегатор, заточенный под кодинг-агентов. Zen — pay-as-you-go ($20, без наценки), Go — $10/мес с щедрыми лимитами на open-source модели. Модели предварительно протестированы и отбенчмарканы для агентной работы. Работает с любыми агентами (не только OpenCode).
